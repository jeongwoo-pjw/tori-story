    ...
    <div className="rounded-2xl bg-background-50 border border-background-200/70 p-5 md:p-6">
      ...
      <div className="flex flex-col md:flex-row gap-5 md:gap-8">
        <div className="flex-1">
          <label className="block text-sm font-label text-foreground-700 mb-2">주인공 이름</label>
          <input
            type="text"
            value={name}
        ...
        <div className="flex-1">
          <label className="block text-sm font-label text-foreground-700 mb-2">아이 나이</label>
    ...
    <div className="rounded-2xl bg-primary-50/20 border-2 border-primary-500 ring-2 ring-primary-400/40 p-5 md:p-6">
      <div className="flex items-center justify-between mb-3">
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-4 py-2 rounded-full font-label text-sm transition-colors cursor-pointer whitespace-nowrap ${
            open
...
export default function CreatePage() {
  ...
  const navRow = (right: React.ReactNode) => (
    <div className="flex items-center justify-between pt-6 mt-4 border-t border-background-200/60">
      {homeBtn}
        ...
        <div className="px-4 md:px-8 lg:px-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center py-6">
              <div className="flex bg-background-100 border border-background-200 rounded-full p-1">
                <button
                  type="button"
                  onClick={() => setTab("select")}
                  className={`px-5 py-2.5 rounded-full text-sm font-label transition-colors cursor-pointer whitespace-nowrap ${
                    tab === "select"
            ...
            {/* ── 콘텐츠 박스 ── */}
            <div className="rounded-3xl border-2 border-background-200 bg-background-50 shadow-sm p-6 md:p-8">

              {/* 박스 제목 */}
              <div className="mb-6 pb-5 border-b border-background-200/60">
                <h2 className="font-heading text-xl md:text-2xl text-foreground-950">
                  {tab === "select"
              ...
              {tab === "select" && (
                <div className="space-y-5">
                  ...
                  <div className="rounded-2xl bg-background-50 border border-background-200/70 p-5 md:p-6">
                    ...
                    <p className="text-sm text-foreground-600 mb-4">동화의 분위기를 결정하는 그림 스타일을 선택하세요.</p>
                ...
                <div>
                    ...
                    <div className="space-y-5">
                      <div className="rounded-2xl bg-background-50 border border-background-200/70 p-5 md:p-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          <button
                            type="button"
                            onClick={() => setCustomChatTopicOpen(!customChatTopicOpen)}
                            className={`px-4 py-2 rounded-full text-sm font-label transition-colors cursor-pointer whitespace-nowrap ${
                              customChatTopicOpen
                                ? "bg-primary-500 text-foreground-950 dark:text-foreground-950"
                                : "bg-accent-100 text-accent-900 border border-accent-200 hover:bg-accent-200"
                        ...
                        {customChatTopicOpen && (
                          <div className="mt-3">
                            <textarea
                              ...
                              onChange={(e) => setCustomChatTopic(e.target.value)}
                              placeholder="원하는 주제를 직접 입력해보세요"
                              rows={2}
                          ...
                          {ART_STYLES.map((style) => {
                            ...
                            return (
                              <button
                                key={style.id}
                                type="button"
                                onClick={() => setChatArtStyle(style.id)}
                                className={`relative rounded-2xl border overflow-hidden text-left transition-all cursor-pointer ${
                                  active
                                    ? "border-primary-500 ring-2 ring-primary-300"
                                    : "border-background-200 hover:border-primary-300"
                  ...
                  {currentStep === 4 && (
                    <div className="space-y-5">
                              ...
                              >
                                ...
                                <div className="flex items-center gap-2 pr-8 flex-wrap">
                                  ...
                                  <div className="flex items-center gap-1.5">
                                    ...
                                    {card.isPro && (
                                      <span className="px-1.5 py-0.5 rounded-md bg-amber-400 text-amber-900 text-[10px] font-label font-semibold leading-none">
                                        PRO
                                      </span>
                                    )}
                                  </div>
                      ...
                      <KoreanMotifSection
                        motifs={chatMotifs}
                        setMotifs={setChatMotifs}
                        open={chatMotifOpen}
                        setOpen={setChatMotifOpen}
                      />
