...
const planFeatures = [
  { label: "무제한 동화 생성",    bg: "bg-primary-300 dark:bg-primary-900/50",   text: "text-foreground-950 dark:text-foreground-900",   border: "border-primary-400 dark:border-primary-800/50" },
  { label: "고화질 저장 · PDF 출력", bg: "bg-accent-300 dark:bg-accent-900/50",  text: "text-foreground-950 dark:text-foreground-900",   border: "border-accent-400 dark:border-accent-800/50" },
  { label: "AI 음성 나레이션",    bg: "bg-secondary-300 dark:bg-secondary-900/50", text: "text-foreground-950 dark:text-foreground-900", border: "border-secondary-400 dark:border-secondary-800/50" },
  { label: "독후 활동 연계",      bg: "bg-primary-400 dark:bg-primary-900/50",   text: "text-foreground-950 dark:text-foreground-900",   border: "border-primary-500 dark:border-primary-800/50" },
  { label: "독서 습관 리포트",    bg: "bg-accent-400 dark:bg-accent-900/50",     text: "text-foreground-950 dark:text-foreground-900",   border: "border-accent-500 dark:border-accent-800/50" },
];
