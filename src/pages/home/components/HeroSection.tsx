  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={`${__BASE_PATH__}hero-bg-2.png`}
          alt="토리동화 히어로 배경"
      ...
      {isLoggedIn && (
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-1.5 animate-bounce-slow">
          <span className="text-[10px] font-label text-white/60 tracking-widest uppercase">scroll</span>
          <div className="flex flex-col items-center gap-0.5">
            <i className="ri-arrow-down-s-line text-white/70 text-xl leading-none"></i>
            <i className="ri-arrow-down-s-line text-white/40 text-xl leading-none -mt-3"></i>
          </div>
        </div>
      )}
    </section>
