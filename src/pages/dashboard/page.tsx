...
export default function DashboardPage() {
  ...
  const monthlyPercent = READING_REPORT.monthlyGoal > 0
    ...
    <main className="min-h-screen bg-background-50 text-foreground-950">
        ...
        <div className="px-4 md:px-8 lg:px-12">
          <div className="max-w-6xl mx-auto">
            <div className="mb-6">
              ...
              <p className="text-sm font-label text-foreground-500">
              ...
              <div className="flex-1 min-w-0 space-y-6">
                ...
                <div className="rounded-2xl bg-background-100 dark:bg-background-100 border border-background-200/70 dark:border-background-300/50 p-5 md:p-6">
                  <div className="flex items-start justify-between mb-1">
                    <div>
                      <h2 className="font-heading text-lg text-foreground-950">어휘 성장 추이</h2>
                  ...
                  <div className="flex items-end justify-between mt-3 flex-wrap gap-2">
                    <p className="text-xs font-label text-foreground-500 dark:text-foreground-500">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="rounded-2xl bg-background-50 dark:bg-background-100 border border-background-200/70 dark:border-background-300/50 p-6">
                    <h2 className="font-heading text-base text-foreground-950 mb-1">자녀별 요약</h2>
                    ...
                    <div className="rounded-xl bg-background-100 dark:bg-background-200 border border-background-200/60 dark:border-background-300/50 p-4 space-y-4">
                      ...
                      <div className="flex gap-2">
                        <div className="flex-1 rounded-lg border border-background-300/60 dark:border-background-400/50 p-3 text-center">
                          ...
                          <p className="text-sm font-label text-primary-600 dark:text-primary-400 font-semibold">한옥</p>
                        </div>
                        <div className="flex-1 rounded-lg border border-background-300/60 dark:border-background-400/50 p-3 text-center">
                          <p className="text-[11px] font-label text-foreground-400 mb-1">교감 감정</p>
                          <p className="text-sm font-label text-accent-600 dark:text-accent-400 font-semibold">기쁨</p>
                        </div>
                        <div className="flex-1 rounded-lg border border-background-300/60 dark:border-background-400/50 p-3 text-center">
                          <p className="text-[11px] font-label text-foreground-400 mb-1">연속 독서</p>
                          <p className="text-sm font-label text-secondary-600 dark:text-secondary-400 font-semibold">5일</p>
                        </div>
                      </div>
                      {/* Personality */}
                  ...
                  <div className="rounded-2xl bg-background-50 dark:bg-background-100 border border-background-200/70 dark:border-background-300/50 p-6 flex flex-col">
                    <h2 className="font-heading text-base text-foreground-950 mb-1">반복 요청 테마</h2>
                    ...
                    <div className="flex flex-col gap-2 flex-1">
                      {RECOMMENDATIONS.map((rec) => (
                        <div
                          key={rec.id}
                          className="flex items-start gap-3 rounded-xl bg-background-100 dark:bg-background-200 p-3.5 flex-1"
                        >
                          <span className="text-lg flex-shrink-0 leading-none mt-0.5">{rec.icon}</span>
                          <p className="text-xs font-label text-foreground-700 dark:text-foreground-400 leading-snug">
                            {rec.title}
                          </p>
                        </div>
                      ))}
                  ...
                  <div className="rounded-2xl bg-background-50 dark:bg-background-100 border border-background-200/70 dark:border-background-300/50 p-6 flex flex-col">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        ...
                        <p className="text-xs font-label text-foreground-400 dark:text-foreground-500 mt-1 leading-snug">
                    ...
                    <div className="flex gap-3 mb-4">
                      <div className="flex-1 rounded-xl bg-background-100 dark:bg-background-200 border border-background-200/60 dark:border-background-300/50 p-4 flex flex-col items-center gap-2.5">
                        <div className="flex items-baseline gap-1.5">
                          <span className="text-3xl font-heading text-foreground-950 leading-none tabular-nums">{focusHours}</span>
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="w-8 h-7 rounded-md flex items-center justify-center bg-background-200 dark:bg-background-300 hover:bg-primary-100 cursor-pointer transition-colors"
                          >
                      ...
                      <div className="flex-1 rounded-xl bg-background-100 dark:bg-background-200 border border-background-200/60 dark:border-background-300/50 p-4 flex flex-col items-center gap-2.5">
                        <div className="flex items-baseline gap-1.5">
                          <span className="text-3xl font-heading text-foreground-950 leading-none tabular-nums">{focusMinutes}</span>
                    ...
                    <div className="mt-auto rounded-xl bg-background-100 dark:bg-background-200 border border-background-200/60 dark:border-background-300/50 p-3.5 flex items-center gap-3">
                      <span className="text-xs font-label text-foreground-500 dark:text-foreground-600 whitespace-nowrap flex-shrink-0">
                        잔여 이용 시간
                      </span>
                      <div className="flex-1 min-w-0 flex items-center">
                        {autoLimit ? (
                          ...
                          <span className="text-sm font-label text-foreground-400 dark:text-foreground-500">
                            제한 해제
                          </span>
                        )}
                      </div>
                  ...
                  {/* 감정 반응 */}
                  <div className="rounded-2xl bg-background-50 dark:bg-background-100 border border-background-200/70 dark:border-background-300/50 p-6">
                    <h2 className="font-heading text-base text-foreground-950 mb-1">감정 반응</h2>
                    ...
                    <div className="rounded-xl bg-background-100 dark:bg-background-200 border border-background-200/60 dark:border-background-300/50 p-5 flex items-end justify-center gap-6">
                      {EMOTION_DATA.map((e, i) => {
                        const size = Math.round(44 + (e.value / EMOTION_DATA[0].value) * 48);
                        const bgColors = [
                        ...
                        return (
                          <div
                            ...
                            style={{ marginBottom: i === 1 ? "12px" : "0" }}
                          >
                            <div
                              className="rounded-full flex flex-col items-center justify-center animate-pulse-bubble"
                              style={{
                                width: `${size}px`,
                                height: `${size}px`,
                            ...
                            >
                              <span className="text-white font-label text-[10px] leading-none mb-0.5">{e.label}</span>
                              <span className="text-white font-heading font-bold text-lg leading-none">{e.value}%</span>
                            </div>
                          </div>
                        );
                      })}
              ...
              <div className="w-full lg:w-80 flex-shrink-0 space-y-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="relative">
                    <button
                      type="button"
                      onClick={() => { setShowNotif(!showNotif); setShowChildDropdown(false); setShowUserDropdown(false); }}
                  ...
                  <div className="relative">
                    <button
                      type="button"
                      onClick={() => { setShowChildDropdown(!showChildDropdown); setShowNotif(false); setShowUserDropdown(false); }}
                  ...
                  <div className="relative">
                    <button
                      type="button"
                      onClick={() => { setShowUserDropdown(!showUserDropdown); setShowNotif(false); setShowChildDropdown(false); }}
                      className="flex items-center gap-1.5 rounded-full border border-background-200 dark:border-background-300 bg-background-50 dark:bg-background-100 px-3 py-1.5 hover:bg-primary-50 dark:hover:bg-background-200 transition-colors cursor-pointer"
                    >
                ...
                <div className="rounded-2xl bg-background-50 dark:bg-background-100 border border-background-200/70 dark:border-background-300/50 p-5 md:p-6">
                  <div className="flex flex-col items-center mb-5">
                    ...
                    <p className="text-sm font-label text-foreground-950">
                      {CHILD_PROFILE.name} ({CHILD_PROFILE.age}세)
                    </p>
                  </div>
                  ...
                  <div className="mb-4 text-center">
                    ...
                    <div className="flex flex-wrap gap-2 justify-center">
                      {CHILD_PROFILE.interests.map((interest) => (
                        <span key={interest} className="inline-flex items-center px-2.5 py-1 rounded-full bg-secondary-100 text-secondary-900 text-xs font-label">
                          {interest}
                        </span>
                      ))}
                    </div>
                ...
                <div className="rounded-2xl bg-background-50 dark:bg-background-100 border border-background-200/70 dark:border-background-300/50 p-5 md:p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Link
                      to="/library"
                      className="text-xs font-label text-primary-500 hover:text-primary-600 transition-colors"
                    >
                      자세히
                    </Link>
                  </div>
                ...
                <div className="rounded-2xl bg-background-50 dark:bg-background-100 border border-background-200/70 dark:border-background-300/50 p-5 md:p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="flex flex-col items-center rounded-xl bg-background-100 dark:bg-background-200 py-4 px-3">
                        <p className="text-xs font-label text-foreground-500 dark:text-foreground-700 mb-2 text-center">평균 독서 시간</p>
                        <p className="text-xl font-heading text-foreground-950">{READING_REPORT.avgTime}</p>
                      </div>
                      <div className="flex flex-col items-center rounded-xl bg-background-100 dark:bg-background-200 py-4 px-3">
                        <p className="text-xs font-label text-foreground-500 dark:text-foreground-700 mb-2 text-center">저장된 동화</p>
                        <p className="text-xl font-heading text-foreground-950">{READING_REPORT.savedCount}<span className="text-sm font-label text-foreground-500">편</span></p>
                      </div>
                    </div>
                    ...
                    <div className="rounded-xl bg-background-100 dark:bg-background-200 p-4 flex items-center gap-4">
                      <div className="flex-1 min-w-0">
                        <p className="text-xs font-label text-foreground-500 dark:text-foreground-700 mb-1">이번달 독서량</p>
                        <p className="text-xl font-heading text-foreground-950">
                          {READING_REPORT.monthlyRead}
                          <span className="text-sm font-label text-foreground-400 ml-1">/ {READING_REPORT.monthlyGoal}편</span>
                        </p>
                        <p className="text-[11px] font-label text-foreground-400 mt-0.5">목표 달성률 {monthlyPercent}%</p>
                      </div>
                      <div className="relative w-16 h-16 flex-shrink-0">
                        <svg viewBox="0 0 36 36" className="w-full h-full" style={{ transform: "rotate(-90deg)" }}>
                          ...
                          <circle
                            ...
                            style={{ transition: progressAnimating ? "stroke-dasharray 1.2s ease-out" : "none" }}
                          />
                        </svg>
                        <div className="absolute inset-0 flex items-center justify-center">
                          <span className="text-xs font-label font-semibold text-foreground-950">{monthlyPercent}%</span>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      {(showNotif || showChildDropdown || showUserDropdown || showPeriodDropdown) && (
        <div
          ...
          onClick={() => { setShowNotif(false); setShowChildDropdown(false); setShowUserDropdown(false); setShowPeriodDropdown(false); }}
        ></div>
      )}
    </main>
  );
