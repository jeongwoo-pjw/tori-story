              ...
              {isLoggedIn ? (
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    title="부모잠금"
                  >
                    <i className="ri-lock-unlock-line text-foreground-700 dark:text-accent-300 w-3.5 h-3.5 flex items-center justify-center text-xs"></i>
                ...
                {isLoggedIn ? (
                  <div className="space-y-1 pt-2 border-t border-primary-200/70">
                    <button
                      type="button"
                      onClick={() => setParentLockOpen(true)}
                      className="w-full flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-label text-foreground-800 dark:text-accent-300 bg-accent-100/60 dark:bg-accent-900/30 border border-accent-300 dark:border-accent-600 cursor-pointer whitespace-nowrap"
                    >
